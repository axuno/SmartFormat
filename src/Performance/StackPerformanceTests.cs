  ...
  Allocated : Allocated memory per single operation (managed only, inclusive, 1KB = 1024B)
    */
    ...
    public class StackPerformanceTests
    {
        ...
        private Stack<Address> _singleStack = new Stack<Address>();
        private ConcurrentStack<Address> _concStack = new ConcurrentStack<Address>();
        private Address _someAddress = new Address();
        private int _counter;


        public StackPerformanceTests()
        {
        }
