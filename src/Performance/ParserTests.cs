 ...
 */
    ...
    public class ParserTests
    {
        ...
        private readonly Parser _parser = new (new SmartSettings());
        ...
        public void Placeholder()
        {
            for (var i = 0; i < N; i++)
            {
                _ = _parser.ParseFormat("{SomePlaceholder}");
            }
        }
        ...
        public void Placeholder0005()
        {
            for (var i = 0; i < N; i++)
            {
                _ = _parser.ParseFormat("{SomePlaceholder1}{SomePlaceholder2}{SomePlaceholder3}{SomePlaceholder4}{SomePlaceholder5}");
            }
        }
        ...
        public void PlaceholderFormatter0002()
        {
            for (var i = 0; i < N; i++)
            {
                _ = _parser.ParseFormat("{SomePlaceholder1:choose:}{SomePlaceholder2:list:}");
            }
        }
        ...
        public void Literal0010Char()
        {
            for (var i = 0; i < N; i++)
            {
                _ = _parser.ParseFormat("1234567890");
            }
        }
        ...
        public void Literal3000Char()
        {
            for (var i = 0; i < N; i++)
            {
                _ = _parser.ParseFormat(LoremIpsum);
            }
        }
        ...
        public void Literal3000Placeholder()
        {
            for (var i = 0; i < N; i++)
            {
                _ = _parser.ParseFormat(LoremIpsum + "{SomePlaceholder}");
            }
        }
    }
}
