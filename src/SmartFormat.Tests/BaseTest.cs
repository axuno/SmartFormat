...
namespace SmartFormat.Tests
{
    public abstract class BaseTest
    {
        public Person GetPerson()
        {
            ...
            var pam = new Person("Pam Halpert", Sex.Female, new DateTime(1980, 1, 1), "111 First St, Scranton, PA 18447");
            var dwight = new Person("Dwight K Schrute", Sex.Male, new DateTime(1978, 2, 2), "222 Second St, Scranton, PA 18447");
