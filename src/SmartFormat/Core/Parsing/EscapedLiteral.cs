...
namespace SmartFormat.Core.Parsing
{
    ...
    public static class EscapedLiteral
    {
        ...
        public static ReadOnlySpan<char> UnEscapeCharLiterals(char escapingSequenceStart, ReadOnlySpan<char> input, int startIndex, int length, bool includeFormatterOptionChars, Span<char> resultBuffer)
        {
